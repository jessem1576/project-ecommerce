...
const ProductsPageClientContent = () => {
  ...
  const minPrice = useMemo(() => Math.min(...mockProducts.map(p => p.price), 0), []);
  ...
  return (
    <div className="space-y-8">
      <section className="text-center py-8 bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10 rounded-lg shadow-inner">
        <h1 className="text-4xl md:text-5xl font-headline font-bold text-primary mb-4">Explore Our Products</h1>
        <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
          Find exactly what you're looking for with our comprehensive product filters.
        </p>
      </section>
